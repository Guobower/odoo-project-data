...
class Exportlogic(models.Model):
	...
	@api.onchange('customer','bill_types')
...
class service_cont_tree(models.Model):
	...
	type_contt           = fields.Char(string="Container Type")
...
class import_cont_tree(models.Model):
	...
	type_contt_imp      = fields.Char(string="Container Type")
